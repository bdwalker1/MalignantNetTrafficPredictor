...
import pandas as pd
import SimpleTimer
import MalignantNetTrafficPredictor
...
if __name__ == '__main__':
    ...
    net_predictor = MalignantNetTrafficPredictor \
        .MalignantNetTrafficPredictor(n_estimators=10, learning_rate=1.0, max_depth=4)
    ...
    net_predictor.load_saved_model("MalignantNetTrafficPredictor-v0.1.model")
